  ...
  return (
    <main className="flex justify-evenly items-center bg-[#0D1732] min-h-[calc(100vh-8rem)]">
      <div className="hidden lg:block w-[45rem] ">
        <img
          src="https://img.freepik.com/free-photo/male-hand-with-pen_155003-6453.jpg?w=996&t=st=1702918093~exp=1702918693~hmac=61bdd2e1e510f26eb29e0c1944649907dc0d6d7e7fd7e60c7a75d13990132d54"
          alt="login"
      ...
      >
        <section className="flex flex-col gap-3 ">
          ...
          <div className="flex flex-col gap-3">
            <label htmlFor="email" className="text-[#EEEDE8]">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="flex flex-col gap-3">
            <label htmlFor="password" className="text-[#EEEDE8]">
              Password
            </label>
            <input
              type="password"
          ...
          <h4 className="flex flex-col gap-3">
            <Link
              to="/login"
              className="text-[#F8B664] block text-center hover:text-[#C6A779]"
            >
