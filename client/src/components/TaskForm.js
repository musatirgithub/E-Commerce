  ...
  return (
    <section className="p-5 mx-auto lg:max-w-5xl ">
      <form
        ...
        className="flex flex-col lg:flex-row gap-3 border-2 rounded-3xl mt-3 pb-3"
        autoComplete="off"
      >
        ...
        <section className="flex justify-center gap-5 px-3">
          <div className="flex  flex-col gap-3">
            <label htmlFor="deadline" className="text-[#EEEDE8] text-center">
              Deadline
            </label>
            <input
              type="datetime-local"
          ...
          <button type="submit" className="btn btn-danger mt-9">
            Add Task
          </button>
        </section>
      </form>
